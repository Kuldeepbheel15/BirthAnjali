...
export default function FinalMessage() {
    ...
    const message = `Dear Anjali Ahari,

    On this Birthday 🍫🍬🍰🎈, I just want to say how lucky I am to have you. You've always been there with your love, support, and those little moments that mean the world to me.
    
    From silly fights to fun memories, every moment with you has been special. You're not just my happiness, but also a friend I can always count on.
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-white to-pink-50 rounded-2xl shadow-[0_8px_24px_rgba(255,192,203,0.3)] p-6 cursor-pointer">
                                        <div className="h-full flex flex-col">
                                            ...
                                            <div className="text-center mb-4">
                                                <h3 className="text-lg font-semibold text-[#DB2777]">💫 Happy Birthday 🎈 🎂 💫</h3>
                                            </div>
