...
export default function MemoryLaneScreen({ onNext }) {
    ...
    const memories = [
        ...
        },
        {
            ...
            description: "In 2022 we had seen each other for the first time in wedding functions",
            emoji: "🍪",
            color: "#a855f7",
        },
        {
            title: "You being my protector",
            description: "Always standing up for me and supports me every time",
            emoji: "🛡️",
            color: "#fbbf24",
        },
        {
